import { User, Mail, Phone, Lock, LucideCircleArrowRight, School, User2 } from "lucide-react";
...
export default function Register() {
        ...
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-orange-50 via-orange-50 to-white relative overflow-hidden">
                ...
                <div className="absolute inset-0 pointer-events-none z-0">
                    <div className="absolute -top-[15%] -left-[10%] w-[45vw] h-[45vw] bg-orange-100/60 rounded-full blur-3xl"></div>
                    <div className="absolute top-[10%] right-[5%] w-[35vw] h-[35vw] bg-blue-100/60 rounded-full blur-3xl"></div>
                    <div className="absolute bottom-[5%] left-[20%] w-[25vw] h-[25vw] bg-orange-200/40 rounded-full blur-3xl"></div>
                </div>
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex justify-between items-center px-10 py-6">
                        <div className="flex items-center gap-2 font-semibold text-slate-800">
                            <div className="w-9 h-9 rounded-xl bg-white flex items-center justify-center shadow-sm border border-white">
  ...
  "
    ...
    "
                    ...
                    {/* Main Section */}
                    <div className="max-w-7xl mx-auto px-10 mt-20 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                        ...
                        <div className="relative">
                            ...
                            <School
                                size={120}
                                className="absolute -top-8 -left-6 text-[#FB8924]/20 rotate-12 pointer-events-none"
                            />

                            <div className="my-8 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/70 border border-white text-primary text-xs font-bold uppercase tracking-wider shadow-sm backdrop-blur-sm relative z-10">
                                <span className="flex h-2 w-2 relative">
                                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#FB8924] opacity-75"></span>
  ...
  "></div>
                            ...
                            <div className="absolute -top-20 -right-10 z-10 pointer-events-none">
                                <User2 size={150} className="text-gray-400/15 rotate-12 " />
                            </div>
                            {/* Glass Card */}
                            <div
                                className="
